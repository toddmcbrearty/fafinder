...
let buildIcons = suggestions => {
    ...
    suggestions_ele.innerHTML = ''
    let results = findFuzzy(suggestions)
    for (var i in results) {
        let result = results[i]
        let _tmpTemplate = template.content.cloneNode(true)
...
let findFuzzy = function (term) {
    let results = fuzzy.filter(term, icons)
